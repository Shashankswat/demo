...
<textarea id="source">
        ...
        <div class="card">
          ...
          <div class="card">
            <div class="card-block">
              ...
              <p class="card-text"><strong>GitHub for Business Hosted</strong> is a private hosted solution on our servers with SAML integration and 99.95% uptime SLA. </p>
        ...
        <div class="card">
          ...
          <div class="card">
            <div class="card-block">
              ...
              <p class="card-text"><strong>GitHub Enterprise</strong> is offered as a hosted solution with Managed Service Providers on their servers.<br/>&nbsp;</p>
            </div> <!-- msp cardblock -->
          </div> <!-- msp card -->
        </div> <!-- on-prem card -->
  ...
  <div class="container">
    <img class="img-resize" src="/images/atom_community.png">
  </div>
  <footer>
    <div class="octicon-spacer"><span class="octicon octicon-logo-github"></span><span class="tagline">how people build software</span></div>
  </footer>
